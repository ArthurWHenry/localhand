    ...
    <Layout>
      <div>
        <div className="flex flex-col justify-center items-center max-w-screen-lg mx-auto h-64 p-6">
          <span className="text-3xl md:text-5xl text-center font-bold mb-6">
            Search local businesses
          </span>
          <div className="flex flex-row justify-between items-center shadow-lg py-3 px-6 w-full border-t-4 bg-white">
            <input
